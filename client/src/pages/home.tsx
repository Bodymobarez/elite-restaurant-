...
export default function Home() {
  ...
  return (
    <CustomerLayout>
      ...
      <section className="py-32 px-6 bg-gradient-to-b from-background via-card/20 to-background relative overflow-hidden">
          ...
          >
            ...
            <div className="flex justify-center gap-4">
              <Link href="/auth?role=restaurant">
                <Button size="lg" className="bg-primary text-primary-foreground hover:bg-primary/90 font-medium shadow-lg shadow-primary/20 hover:shadow-primary/40 transition-all hover:translate-y-[-2px]" data-testid="button-partner">
