        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex justify-between items-end mb-12">
            ...
            <Link href="/restaurants">
              <Button variant="link" className="text-primary hover:text-primary/80 p-0 gap-2">
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex justify-center gap-4">
             <Link href="/auth?role=restaurant">
              <Button size="lg" variant="outline" className="border-primary/50 text-primary hover:bg-primary hover:text-primary-foreground">
                Partner With Us
              </Button>
             </Link>
          </div>
